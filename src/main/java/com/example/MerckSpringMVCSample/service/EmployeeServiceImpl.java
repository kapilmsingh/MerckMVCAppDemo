...
import com.example.MerckSpringMVCSample.dao.IEmployeeDAO;
...
public class EmployeeServiceImpl implements IEmployeeService {
	...
	List<Employee> empList =new ArrayList<>(Arrays.asList(
			new Employee(1,"Rohan", "Sarkar","Payments"),
			new Employee(2,"Rohit","Das", "DSOS"),
			new Employee(3,"Ritha","Singh","PCF")));
