...
<div class="form-group">
  <label class="col-form-label" for="empName">Employee First Name:</label>
   	<form:input path="empName" value="${employeeDetails.empName}" class="form-control"/>
	<form:errors path="empName" class="form-control"/><br/>
</div>

<div class="form-group">
  <label class="col-form-label" for="empLastName">Employee Last Name:</label>
   	<form:input path="empLastName" value="${employeeDetails.empLastName}" class="form-control"/>
	<form:errors path="empLastName" class="form-control"/><br/>
</div>
