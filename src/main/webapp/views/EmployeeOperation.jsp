...
<thead>
<tr class="table-primary"><th scope="col">Employee ID</th><th scope="col">First Name</th><th scope="col">Last Name</th><th scope="col">Department</th></tr>
</thead>
<tbody>
<tr>
	<td> <c:out value="${employeeData.empId}"/></td>
    <td> <c:out value="${employeeData.empName}"/></td>  
    <td> <c:out value="${employeeData.empLastName}"/></td>
